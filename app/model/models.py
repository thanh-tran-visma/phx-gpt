from sqlalchemy import Column, Integer, Enum, TIMESTAMP, ForeignKey, Text, Float
...
class MessageVector(Base):
    ...
    message_id = Column(Integer, ForeignKey('messages.id'), index=True)  # Ensure this points to the correct foreign key
